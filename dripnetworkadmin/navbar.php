...
<?php
$select = mysqli_query($dbc,"SELECT * FROM `dripnetwork_admin` WHERE `username` = '".$_SESSION['login']."' ");
...
<nav class="navbar navbar-expand-md navbar  mb-4" style="background-color: black;">
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      ...
      <li class="nav-item">
          <a class="nav-link" href="dashboard.php" style="color:yellow;" ><i class="fa fa-user-circle"> </i> Welcome <?php echo $uname; ?> </a>
        </li>
