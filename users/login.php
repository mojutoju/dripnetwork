...
<div class="main">
    ...
    <br>
      <h3 style="color:white; text-align:center;"> Sign <strong style="color:orange;"> In </strong></h3>
            <p style="color:white; text-align:center;">Access your dashboard , <strong style="color:yellow;"> Contestants Only.</strong> </p>
...
if(isset($_POST['login'])){
  ...
  $sql = mysqli_query($dbc, "SELECT * FROM `dripnetwork_users` WHERE username = '".$username."' AND password = '".$password."' AND status = 'Paid'");
...
<?php
    ...
    $sql = mysqli_query($dbc, "SELECT * FROM `dripnetwork_users` WHERE username = '".$username."' AND password = '".$password."' AND status = 'Not Paid'  ");
    $num = mysqli_fetch_array($sql);
...
?>
    ...
    font-style: normal;
    line-height: 1.57;
    letter-spacing: -.11px;" value="Sign In" name="login"> 
...
<br>
    ...
    <p style="color:white; text-align:center;"> Not registered yet ? <a href="signup.php" style="color:orange; text-align:center;"> Click Here</a>  </p>
      
    <p style="color:white; text-align:center;"> Forgot Password ? <a href="resetpassword.php" style="color:orange; text-align:center;"> Click Here</a>  </p>
