...
Create <strong style="color:yellow;"> Packages </strong>
</h2>
...
button: "Close",
 ...
 <?php
  ...
  $insert = mysqli_query($dbc, "INSERT INTO `dripnetwork_packages` VALUES ('NULL', '$packagename', '$file', '$size', '$content', '$type', '$location', '$packagetype', '$currency', '$amount', '$description', '$designated_date'  , '$capacity'  , now()) ");
...
<script>
    ...
    swal({
          text: "Success",
  title: " <?php echo $packagename; ?> Package Created  ",
...
<form name="packages" method="POST" action="createpackages.php" enctype="multipart/form-data" >
<div class="row">
<div class="col-md-6 mb-3">
<div class="form-group">
    <label style="color:white;"> Package Name </label>
<input type="text" class="form-control" style="background-color:black; color:white;"  name="packagename" placeholder="Package Name" required>
</div>
...
<label style="color:white;"> Amount </label>
    <input  class="form-control" type="text" name="amount" placeholder="Amount" style="background-color:black; color:white;" >
...
<textarea  rows="10" name="description" placeholder="Type Here..." class="form-control" style="background-color:black; color:white;" required></textarea>
...
<input type="date" class="form-control" name="designated_date" style="background-color: black; color:white;" required>
</div>
...
<input type="number" class="form-control" name="capacity" style="background-color: black; color:white;" min="10"  required>
</div>
...
<input type="submit" class="btn btn" name="packages" value="Create Package" style="background-color: yellow; border-radius: 13px; color:black; font-weight: 800;">
